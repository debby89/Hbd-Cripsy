...
const Home = () => {
  return (
    <div className="relative h-screen bg-black">
      ...
      <div className="flex justify-center items-center space-x-4 p-5">
        <a href="/Cripsy">
          <button className="bg-white rounded-full text-black px-4 py-2 hover:bg-red-400" aria-label="Cripsy">Cripsy🖤</button>
        </a>
        <a href="/Teddy">
          <button className="bg-white rounded-full text-black px-4 py-2 hover:bg-blue-400" aria-label="Teddy">Teddy🖤</button>
        </a>
        <a href="/Wifey">
          <button className="bg-white rounded-full text-black px-4 py-2 hover:bg-pink-400" aria-label="Wifey">Wifey🖤</button>
        </a>
      </div>
    </div>
  );
